...
.back-btn { display: flex; align-items: center; gap: 4px; font-size: var(--font-sm); color: var(--text-secondary); background: transparent; border: none; cursor: pointer; padding: 4px 8px; border-radius: 4px; transition: all 0.15s; font-family: inherit; }
.back-btn:hover { color: var(--text-primary); background: var(--bg-hover); }
.detail-title { font-size: var(--font-base); font-weight: 600; color: var(--text-primary); flex: 1; }
...
.daily-badge { display: inline-block; font-size: var(--font-xs); font-weight: 700; color: var(--accent); background: var(--accent-bg); border: 1px solid var(--accent); padding: 3px 10px; border-radius: 3px; letter-spacing: 1px; margin-bottom: 8px; }
.rpt-title { font-size: 22px; font-weight: 700; color: var(--text-primary); margin: 0 0 4px 0; }
.rpt-subtitle { font-size: var(--font-sm); color: var(--text-secondary); }
...
.rpt-date-year { font-size: var(--font-sm); color: var(--text-secondary); margin-top: 4px; }
...
.meta-label { font-size: var(--font-xs); color: var(--text-secondary); }
.meta-value { font-size: var(--font-base); color: var(--text-primary); font-weight: 600; }
...
.stat-icon-wrap { width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: var(--font-lg); flex-shrink: 0; }
...
.ai-summary-header { display: flex; align-items: center; gap: 6px; font-size: var(--font-base); font-weight: 600; color: var(--text-primary); margin-bottom: 12px; }
.ai-icon { font-size: var(--font-lg); }
...
.ai-score-den { font-size: var(--font-xs); color: var(--text-secondary); }
.ai-summary-text { flex: 1; }
.ai-tag-line { display: flex; align-items: center; gap: 4px; margin-bottom: 4px; }
.ai-tag { font-size: var(--font-base); font-weight: 700; }
.ai-focus { font-size: var(--font-sm); color: var(--text-muted); }
.ai-desc { font-size: var(--font-sm); color: var(--text-muted); line-height: 1.6; }
...
.ai-point-icon { font-size: var(--font-md); flex-shrink: 0; margin-top: 1px; }
.ai-point-content { flex: 1; }
.ai-point-title { font-size: var(--font-sm); font-weight: 600; color: var(--text-primary); margin-bottom: 2px; }
.ai-point-text { font-size: var(--font-sm); color: var(--text-muted); line-height: 1.5; }
...
.sys-icon { font-size: var(--font-lg); flex-shrink: 0; }
.sys-name { flex: 1; font-size: var(--font-base); font-weight: 600; color: var(--text-primary); }
.sys-status-badge { font-size: var(--font-xs); font-weight: 600; padding: 3px 10px; border-radius: 3px; }
...
.sys-table { width: 100%; border-collapse: collapse; font-size: var(--font-sm); }
.sys-table th { background: var(--bg-panel); color: var(--text-secondary); font-weight: 600; text-align: left; padding: 10px 14px; border-bottom: 1px solid var(--border-primary); font-size: var(--font-sm); }
...
.item-unit-label { font-size: var(--font-xs); color: var(--text-secondary); font-weight: 400; }
.item-value { color: var(--text-primary); font-weight: 600; font-family: Consolas, monospace; }
.item-range { color: var(--text-muted); font-family: Consolas, monospace; font-size: var(--font-sm); }
.item-status { font-size: var(--font-sm); padding: 2px 8px; border-radius: 3px; font-weight: 500; }
...
.item-remark { font-size: var(--font-sm); color: var(--text-secondary); max-width: 200px; }
</style>
